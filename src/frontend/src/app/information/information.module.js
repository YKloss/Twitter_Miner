...
var information_routing_module_1 = require("./information-routing.module");
...
InformationModule = __decorate([
    core_1.NgModule({
        imports: [
            information_routing_module_1.InformationRoutingModule,
        ],
        declarations: [information_component_1.InformationComponent]
    })
], InformationModule);
